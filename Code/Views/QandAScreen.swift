...
struct QandAScreen: View {
  ...
  @Binding var   qarb: QAReturnBlock?
        ...
        .timeoutAlert(item: $answerGiven,
          ...
          // Delay execution of the next steps
            ...
            if let answerGiven = answerGiven {
              ...
              case true: qarb = answeredCorrectly(ch,row:row,col:col,answered:answerGiven,elapsed:elapsedTime)
              case false: qarb = answeredIncorrectly(ch,row:row,col:col,answered: answerGiven,elapsed:elapsedTime)
              }
